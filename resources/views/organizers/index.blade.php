                            ...
                            @foreach ($organizers as $organizer)
                                <tr>
                                    ...
                                    <td class="py-2 px-4 border-b">
                                        <a href="{{ route('organizers.show', $organizer) }}" class="text-blue-500 hover:underline">Просмотр</a>
                                        <a href="{{ route('organizers.edit', $organizer) }}" class="text-yellow-500 hover:underline ml-2">Редактировать</a>
