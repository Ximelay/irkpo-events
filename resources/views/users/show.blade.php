            ...
            <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg">
                <div class="p-6 bg-white border-b border-gray-200">
                    ...
                    <div class="mb-4">
                        ...
                        <p class="text-gray-900">{{ $user->user_lastName }}</p>
                    </div>
                    <div class="mb-4">
                        <strong class="text-gray-700">Имя:</strong>
                        <p class="text-gray-900">{{ $user->user_firstName }}</p>
                    </div>
                    <div class="mb-4">
                        <strong class="text-gray-700">Отчество:</strong>
                        <p class="text-gray-900">{{ $user->user_middleName }}</p>
                    </div>
                    <div class="mb-4">
                    ...
                    <div class="mb-4">
                        ...
                        <p class="text-gray-900">{{ $user->group->groupName ?? 'N/A' }}</p>
                    </div>
                    <a href="{{ route('users.index') }}" class="text-blue-600 hover:text-blue-800 font-medium">Назад к списку</a>
                </div>
            </div>
        </div>
    </div>
