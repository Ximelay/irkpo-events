                            ...
                            @foreach ($inventories as $inventory)
                                <tr>
                                    ...
                                    <td class="py-2 px-4 border-b">
                                        <a href="{{ route('inventories.show', $inventory) }}" class="text-blue-500 hover:underline">Просмотр</a>
                                        <a href="{{ route('inventories.edit', $inventory) }}" class="text-yellow-500 hover:underline ml-2">Редактировать</a>
