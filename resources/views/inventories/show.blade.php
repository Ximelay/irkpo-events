        ...
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg">
                <div class="p-6 bg-white border-b border-gray-200">
                    ...
                    <div class="mb-4">
                        <strong class="text-gray-700">Количество:</strong>
                    ...
                    <div class="mb-4">
                        ...
                        <p class="text-gray-900">{{ $inventory->events->title }}</p>
                    </div>
                    <a href="{{ route('inventories.index') }}" class="text-blue-500 hover:underline">Назад к списку</a>
                </div>
            </div>
        </div>
    </div>
