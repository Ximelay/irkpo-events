                ...
                <div class="p-6 bg-white border-b border-gray-200">
                    <form action="{{ route('events.store') }}" method="POST">
                        ...
                        <div class="mb-4">
                            ...
                            <input type="datetime-local" name="startDateTime" id="startDateTime" value="{{ old('startDateTime') }}"
                        ...
                        <div class="mb-4">
                            ...
                            <select name="eventTypes_eventTypeID" id="eventTypes_eventTypeID"
                                ...
                                @foreach($eventTypes as $type)
                                    <option value="{{ $type->eventTypeID }}" {{ old('eventTypes_eventTypeID') == $type->eventTypeID ? 'selected' : '' }}>
                                        {{ $type->eventType }}
                                    </option>
                                @endforeach
                            </select>
                        ...
                        <div class="mb-4">
                            ...
                            <select name="eventStatuses_eventStatusID" id="eventStatuses_eventStatusID"
                                ...
                                @foreach($eventStatuses as $status)
                                    <option value="{{ $status->eventStatusID }}" {{ old('eventStatuses_eventStatusID') == $status->eventStatusID ? 'selected' : '' }}>
                                        {{ $status->eventStatus }}
                                    </option>
                                @endforeach
                            </select>
                        ...
                        <div class="mb-4">
                            ...
                            <select name="faculties_facultyID" id="faculties_facultyID"
                                ...
                                @foreach($faculties as $faculty)
                                    <option value="{{ $faculty->facultyID }}" {{ old('faculties_facultyID') == $faculty->facultyID ? 'selected' : '' }}>
                                        {{ $faculty->facultyName }}
                                    </option>
                                @endforeach
                            </select>
                        ...
                        <div class="mb-4">
                            ...
                            <select name="organizers_organizerID" id="organizers_organizerID"
                                ...
                                @foreach($organizers as $organizer)
                                    <option value="{{ $organizer->organizerID }}" {{ old('organizers_organizerID') == $organizer->organizerID ? 'selected' : '' }}>
