                            ...
                            @foreach ($inventoryCategories as $category)
                                <tr>
                                    ...
                                    <td class="py-2 px-4 border-b">
                                        <a href="{{ route('inventory-categories.show', $category) }}" class="text-blue-500 hover:underline">Просмотр</a>
                                        <a href="{{ route('inventory-categories.edit', $category) }}" class="text-yellow-500 hover:underline ml-2">Редактировать</a>
