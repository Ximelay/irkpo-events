            ...
            <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg">
                <div class="p-6 bg-white border-b border-gray-200">
                    <div class="mb-4">
                        ...
                        <p class="text-gray-900">{{ $specialty->specialityID }}</p>
                    </div>
                    <div class="mb-4">
                        <strong class="text-gray-700">Название:</strong>
                        <p class="text-gray-900">{{ $specialty->specialityName }}</p>
                    </div>
                    <div class="mb-4">
                        <strong class="text-gray-700">Код:</strong>
                        <p class="text-gray-900">{{ $specialty->specialityCode }}</p>
                    </div>
                    <div class="mb-4">
